...
p_result <- run_simulations(setup = 0, m = 100, sim_model = c("simulate_data_np", "simulate_data_ph", "simulate_data_po", "simulate_data_real"), model = c("np","ph","po","roc","pred","pred.adj"), boot = TRUE)
print(p_result)
